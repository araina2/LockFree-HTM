...
#define CASIO(a,b,c) __sync_val_compare_and_swap(a,b,c) 
#define FASIO FAS
/* Update Pointer location, return Old value. */
#define CASPO(a,b,c) __sync_val_compare_and_swap(a,b,c) 
#define FASPO FAS
...
#define WMB(o) __asm__ __volatile__ ("" : : : "memory")
#define RMB() MB()
...
typedef /*unsigned*/ long double tick_t;
#define RDTICK() \
