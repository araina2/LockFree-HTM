...
static unsigned int strong_ll(unsigned long long *ptr, int p)
{
    ...
    return (unsigned int) (val_read >> 32);
}

static int strong_vl(unsigned long long *ptr, int p) 
{
    unsigned long long val_read;
    unsigned long long flag;
...
static int strong_sc(unsigned long long *ptr, int p, unsigned int n) 
{
    unsigned long long val_read;
    unsigned long long new_val;
    unsigned long long flag;
    ...
    while ( (val_read & flag) != 0 )
    {
        new_val = (((unsigned long long)n) << 32);
...
static void s_store(unsigned long long *ptr, unsigned int n) 
{
    unsigned long long new_val;
...
static unsigned int s_load(unsigned long long *ptr) 
{
    unsigned long long val_read;
